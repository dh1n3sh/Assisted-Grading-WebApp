...
class QpNodeAdjList(models.Model):
    ...
    childNode = models.ForeignKey(
        QpNode, on_delete=models.CASCADE, related_name='QpdNodeToChild')
...
class GradeNodeAdjList (models.Model):
    ...
    childNode = models.ForeignKey(
        GradeNode, on_delete=models.CASCADE, related_name='GradeNodeToChild')
